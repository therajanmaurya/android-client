 ...
 * and an identifier int that identifies the type of entity generating the DataTable request.
 *
...
public class DataTableListFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        getActivity().setTitle("Datatables");
    ...
    public void onSaveActionRequested() throws RequiredFieldException {
        ...
        for (int i = 0; i < dataTables.size(); i++) {
            com.mifos.objects.datatablepayload.DataTable dataTable = new
                    com.mifos.objects.datatablepayload.DataTable();
            dataTable.setRegisteredTableName(dataTables.get(i).getRegisteredTableName());
            dataTable.setData(addDataTableInput(i));
            dataTablePayloadElements.add(dataTable);
        }
    ...
    @Override
    public void showMessage(int messageId, String successOrFail) {
        Toaster.show(rootView, getActivity().getResources()
                .getString(messageId));
        if (successOrFail.matches("success")) {
